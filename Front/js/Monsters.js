...
var basePotimonList = [
    //new PotimonBaseStats(id, name, experienceDonnee, hp, mana, attaque, defence, specialAttaque, specialDefence,
    //                      speed, type, evolution, evolutionLevel, futureSkills, tauxDeCapture)
    /*new BasePotimon(
    ...
    new BasePotimon(
        '7', strPotipuce, 44, 48, 65, 50, 64, 43, 4, null, null, 63,
        [new FutureSkill(strGriffe, 1), new FutureSkill(strAquaBall, 1)],
        45,
    ),
    new BasePotimon(
        '4', strPotimeche, 39, 52, 43, 60, 50, 65 , 7, null, null, 62,
