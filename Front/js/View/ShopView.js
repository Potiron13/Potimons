...
ShopView.prototype = {
    ...
    render: function(items) {
        ...
        var potiflouz = displayElementOnParent('div', 'potiflouzShop', 'col-sm-2', GetPotiflouz() + '$', potiflouzRow);
        $.each(items, function(index){
            var item = this;
            var itemRow = displayElementOnParent('div', 'itemShopRow' + this.id, 'row', '', modalBody);
            var itemLabel = displayElementOnParent('div', 'itemShopLabel' + this.id, 'col-sm-2', this.name, itemRow);
            var itemPrice = displayElementOnParent('div', 'itemShopPrice' + this.id, 'col-sm-2', this.price + '$', itemRow);
