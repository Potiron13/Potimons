...
CombatView.prototype = {
    ...
    displayEquipeInfo: function (viewModelsInfoPlayer, className, parent) {
        var colInfoEquipe = displayElementOnParent('div', 'colInfoEquipe',  className + ' combatInfoEquipe', '', parent);
