...
var AllEffects = [    
    ...
    new Effect(3, strDodo, faibleChance, effectIdle),
    new Effect(4, strConfusion, faibleChance, effectConfusion),
    new Effect(5, strConfusion, moyenneChance, effectConfusion),
    new Effect(6, strParalysie, faibleChance, effectIdle),
